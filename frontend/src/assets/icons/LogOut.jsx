export const LogOutIcon = () => {
    ...
    return (
        <svg className = "h-10 w-10 my-10" data-slot="icon" aria-hidden="true" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
